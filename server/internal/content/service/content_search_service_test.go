...
func TestSearchBoxes(t *testing.T) {
	...
	svc := NewContentService(repo, fakeStorage{}, Viewer{}, 0, nil, StampDeps{Sync: 2, Async: 2}, ArchiveDeps{})
...
func TestSearchBoxesStopwordOnly(t *testing.T) {
	svc := NewContentService(&textFakeRepo{}, fakeStorage{}, Viewer{}, 0, nil, StampDeps{Sync: 2, Async: 2}, ArchiveDeps{})
