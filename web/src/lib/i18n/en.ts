...
export const en: Record<keyof Dict, string> = {
	...
	'activity.engagement.summary': '{opens} opens · {read} read',
	'activity.engagement.summaryOne': '{opens} open · {read} read',
	'activity.engagement.opens': '{n} opens',
	'activity.engagement.opensOne': '{n} open',
	'activity.engagement.viewers': '{n} readers',
	'activity.engagement.viewersOne': '{n} reader',
	'activity.engagement.unread': 'Not opened yet',
	'activity.engagement.rawHits': '{n} raw hits before dedup',
	'activity.engagement.jump': 'Jump to page {n}',
	'activity.engagement.loading': 'Loading read activity…',
	'activity.engagement.empty.title': 'No reading yet',
	'activity.engagement.empty.body':
		'Numbers appear once someone opens this document. Page opens and read time are recorded on their own.',
