...
export const en: Record<keyof Dict, string> = {
	...
	'ws.access.until': 'Your access is valid until',
	...
	'ws.brand.open': 'Appearance',
	'ws.brand.title': 'Room appearance',
	'ws.brand.desc':
		"The logo and hero background are visible to this room's members only. Leave both empty for the default look.",
	'ws.brand.readOnly': 'Appearance cannot change while the room is archived.',
	'ws.brand.logo': 'Logo',
	'ws.brand.logoHint': 'PNG, JPEG, or WebP up to 2 MB. Stored as a PNG of at most 512 px.',
	'ws.brand.logoAlt': '{name} logo',
	'ws.brand.logoUpload': 'Upload logo',
	'ws.brand.logoUploading': 'Uploading…',
	'ws.brand.logoRemove': 'Remove logo',
	'ws.brand.logoSaved': 'Logo updated.',
	'ws.brand.logoRemoved': 'Logo removed.',
	'ws.brand.hero': 'Hero background',
	'ws.brand.heroHint': 'Same pattern, different colour; text stays readable on every option.',
	'ws.brand.heroAuto': 'Automatic',
	'ws.brand.heroSaved': 'Hero background updated.',
	'ws.brand.close': 'Close',
	'ws.brand.preset.tide': 'Tide',
	'ws.brand.preset.reef': 'Reef',
	'ws.brand.preset.lagoon': 'Lagoon',
	'ws.brand.preset.slate': 'Slate',
	'ws.brand.preset.harbor': 'Harbour',
	'ws.brand.preset.moss': 'Moss',
	'ws.brand.preset.olive': 'Olive',
	'ws.brand.preset.clay': 'Clay',
	'ws.brand.preset.plum': 'Plum',
	'ws.brand.preset.ember': 'Ember',
	...
	'activity.action.member_expiry_changed': 'set the access period of {target} until {to}',
	'activity.action.member_expiry_cleared': 'removed the access limit of {target}',
	...
	'activity.action.workspace_logo_removed': 'removed the logo of room “{target}”',
	'activity.action.workspace_hero_changed': 'changed the hero background of room “{target}”',
	...
	'activity.label.member_expiry_changed': 'Access period changed',
	...
	'activity.label.workspace_updated': 'Room updated',
	'activity.label.workspace_branding_changed': 'Room appearance changed',
	...
	'activity.engagement.desc': 'Who opened this document, for how long, and which pages held them.',
	'activity.engagement.back': 'Back to folder',
	'activity.engagement.openDoc': 'Open document',
	'activity.engagement.refresh': 'Refresh',
	'activity.engagement.export': 'Export CSV',
	'activity.engagement.exportTitle': 'Download every reader’s time per page as CSV',
	'activity.engagement.summary': '{n} readers · {read} read',
	'activity.engagement.summaryOne': '{n} reader · {read} read',
	'activity.engagement.pageCount': '{n} pages',
	'activity.engagement.pageCountOne': '{n} page',
	'activity.engagement.opens': '{n} opens',
	'activity.engagement.opensOne': '{n} open',
	'activity.engagement.pagesOf': '{n} of {total} pages',
	'activity.engagement.lastRead': 'last {when}',
	'activity.engagement.readers': 'Readers',
	'activity.engagement.openReader': 'Show pages read by {name}',
	'activity.engagement.group.none': 'No longer a member',
	'activity.engagement.group.noneHint':
		'Their membership was removed, so their group is no longer known.',
	'activity.engagement.group.summary': '{n} readers · {read}',
	'activity.engagement.group.summaryOne': '{n} reader · {read}',
	'activity.engagement.pick.title': 'Pick a reader',
	'activity.engagement.pick.body':
		'Their page chart appears here — which pages they opened, and for how long.',
	'activity.engagement.card.reader': 'Reader',
	'activity.engagement.card.group': 'Group',
	'activity.engagement.card.total': 'Total read',
	'activity.engagement.card.longest': 'Longest',
	'activity.engagement.card.longestAt': 'p. {n} · {read}',
	'activity.engagement.card.opens': 'Opened',
	'activity.engagement.card.last': 'Last read',
	'activity.engagement.chart.label': 'Read time per page for {name}',
	'activity.engagement.chart.caption':
		'{seen} of {total} pages opened. Bar height = time the page was open. Pages without a bar were not opened.',
	'activity.engagement.chart.captionNone': 'No page has been recorded as opened yet.',
	'activity.engagement.chart.page': 'Page {n}',
	'activity.engagement.chart.unread': 'Not opened',
	'activity.engagement.chart.noTime': 'Opened, no read time recorded yet',
	'activity.engagement.chart.beyond':
		'Page {n} belongs to an earlier version, not the one served now.',
	'activity.engagement.chart.keys': 'Left/right arrows move between pages.',
	'activity.engagement.view.chart': 'Chart',
	'activity.engagement.view.table': 'Table',
	'activity.engagement.table.page': 'Page',
	'activity.engagement.table.read': 'Read time',
	'activity.engagement.table.opens': 'Opened',
	'activity.engagement.table.open': 'Open',
	'activity.engagement.table.openOf': 'Open page {n} in the viewer',
	'activity.engagement.table.unread': 'Not opened: {ranges}',
	...
	'activity.engagement.readerMissing': 'This reader is not in the list. Pick another reader.',
	'activity.engagement.err.load': 'Could not load read activity.',
	'activity.engagement.retry': 'Try again',
	'activity.engagement.hint':
		'Read time is reported by the reader’s browser — indicative, not precise. Time counts only while the viewer window is focused.',
	...
	'fmt.dur.s': '{s} sec',
	'fmt.dur.m': '{m} min',
	'fmt.dur.ms': '{m} min {s} sec',
	'fmt.dur.h': '{h} hr',
	'fmt.dur.hm': '{h} hr {m} min',
	...
	'member.invite.expiryLabel': 'Access valid until',
	'member.invite.expiryHint':
		'Optional. After this date the guest cannot enter the room until their access is extended. Leave empty for no limit.',
	...
	'member.expiry': 'Access period',
	'member.expiry.aria': "Set {name}'s access period",
	'member.expiry.until': 'Until',
	'member.expiry.lapsed': 'Expired',
	'member.expiry.title': 'Member access period',
	'member.expiry.desc':
		'Set until when {name} can enter this room. Extending an expired member restores their access immediately.',
	'member.expiry.dateLabel': 'Valid until',
	'member.expiry.hint': 'Access ends at the end of that day, in your timezone.',
	'member.expiry.clear': 'Remove limit',
	'member.expiry.submit': 'Save',
	'member.expiry.submitting': 'Saving…',
	'member.expiry.saved': 'Access period updated.',
	...
	'pending.accessUntil': 'Access until',
