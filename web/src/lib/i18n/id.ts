...
export const id = {
	...
	'ws.brand.open': 'Tampilan',
	'ws.brand.title': 'Tampilan ruang data',
	'ws.brand.desc':
		'Logo dan latar hero hanya terlihat oleh anggota ruang ini. Kosongkan keduanya untuk tampilan bawaan.',
	'ws.brand.readOnly': 'Tampilan tidak bisa diubah saat ruang diarsipkan.',
	'ws.brand.logo': 'Logo',
	'ws.brand.logoHint':
		'PNG, JPEG, atau WebP hingga 2 MB. Disimpan ulang sebagai PNG maksimal 512 px.',
	'ws.brand.logoAlt': 'Logo {name}',
	'ws.brand.logoUpload': 'Unggah logo',
	'ws.brand.logoUploading': 'Mengunggah…',
	'ws.brand.logoRemove': 'Hapus logo',
	'ws.brand.logoSaved': 'Logo diperbarui.',
	'ws.brand.logoRemoved': 'Logo dihapus.',
	'ws.brand.hero': 'Latar hero',
	'ws.brand.heroHint': 'Pola yang sama dengan warna berbeda; teks tetap terbaca di semua pilihan.',
	'ws.brand.heroAuto': 'Otomatis',
	'ws.brand.heroSaved': 'Latar hero diperbarui.',
	'ws.brand.close': 'Tutup',
	'ws.brand.preset.tide': 'Pasang',
	'ws.brand.preset.reef': 'Karang',
	'ws.brand.preset.lagoon': 'Laguna',
	'ws.brand.preset.slate': 'Batu tulis',
	'ws.brand.preset.harbor': 'Pelabuhan',
	'ws.brand.preset.moss': 'Lumut',
	'ws.brand.preset.olive': 'Zaitun',
	'ws.brand.preset.clay': 'Tanah liat',
	'ws.brand.preset.plum': 'Plum',
	'ws.brand.preset.ember': 'Bara',
	...
	'activity.action.workspace_logo_removed': 'menghapus logo ruang “{target}”',
	'activity.action.workspace_hero_changed': 'mengganti latar hero ruang “{target}”',
	...
	'activity.label.workspace_updated': 'Ruang diperbarui',
	'activity.label.workspace_branding_changed': 'Tampilan ruang diubah',
	...
	'activity.engagement.desc':
		'Siapa membuka dokumen ini, berapa lama, dan di halaman mana mereka bertahan.',
	'activity.engagement.back': 'Kembali ke folder',
	'activity.engagement.openDoc': 'Buka dokumen',
	'activity.engagement.refresh': 'Muat ulang',
	'activity.engagement.export': 'Ekspor CSV',
	'activity.engagement.exportTitle': 'Unduh lama baca per halaman semua pembaca sebagai CSV',
	'activity.engagement.summary': '{n} pembaca · {read} dibaca',
	'activity.engagement.summaryOne': '{n} pembaca · {read} dibaca',
	'activity.engagement.pageCount': '{n} halaman',
	'activity.engagement.pageCountOne': '{n} halaman',
	'activity.engagement.opens': '{n} buka',
	'activity.engagement.opensOne': '{n} buka',
	'activity.engagement.pagesOf': '{n} dari {total} halaman',
	'activity.engagement.lastRead': 'terakhir {when}',
	'activity.engagement.readers': 'Pembaca',
	'activity.engagement.openReader': 'Lihat halaman yang dibaca {name}',
	'activity.engagement.group.none': 'Bukan anggota lagi',
	'activity.engagement.group.noneHint':
		'Keanggotaannya sudah dicabut, jadi grupnya tidak lagi diketahui.',
	'activity.engagement.group.summary': '{n} pembaca · {read}',
	'activity.engagement.group.summaryOne': '{n} pembaca · {read}',
	'activity.engagement.pick.title': 'Pilih pembaca',
	'activity.engagement.pick.body':
		'Grafik halamannya tampil di sini — halaman mana yang dibuka, dan berapa lama.',
	'activity.engagement.card.reader': 'Pembaca',
	'activity.engagement.card.group': 'Grup',
	'activity.engagement.card.total': 'Total membaca',
	'activity.engagement.card.longest': 'Terlama',
	'activity.engagement.card.longestAt': 'hal. {n} · {read}',
	'activity.engagement.card.opens': 'Dibuka',
	'activity.engagement.card.last': 'Terakhir dibaca',
	'activity.engagement.chart.label': 'Lama baca per halaman untuk {name}',
	'activity.engagement.chart.caption':
		'{seen} dari {total} halaman dibuka. Tinggi batang = lama halaman terbuka. Halaman tanpa batang tidak dibuka.',
	'activity.engagement.chart.captionNone': 'Belum ada halaman yang tercatat terbuka.',
	'activity.engagement.chart.page': 'Halaman {n}',
	'activity.engagement.chart.unread': 'Tidak dibuka',
	'activity.engagement.chart.noTime': 'Dibuka, lama baca belum tercatat',
	'activity.engagement.chart.beyond':
		'Halaman {n} ada di versi sebelumnya, bukan versi yang disajikan sekarang.',
	'activity.engagement.chart.keys': 'Panah kiri/kanan berpindah halaman.',
	'activity.engagement.view.chart': 'Grafik',
	'activity.engagement.view.table': 'Tabel',
	'activity.engagement.table.page': 'Halaman',
	'activity.engagement.table.read': 'Lama baca',
	'activity.engagement.table.opens': 'Dibuka',
	'activity.engagement.table.open': 'Buka',
	'activity.engagement.table.openOf': 'Buka halaman {n} di viewer',
	'activity.engagement.table.unread': 'Tidak dibuka: {ranges}',
	...
	'activity.engagement.readerMissing': 'Pembaca ini tidak ada di daftar. Pilih pembaca lain.',
	'activity.engagement.err.load': 'Gagal memuat aktivitas baca.',
	'activity.engagement.retry': 'Coba lagi',
	'activity.engagement.hint':
		'Lama baca dilaporkan peramban pembaca — indikatif, bukan presisi. Waktu dihitung hanya selama jendela viewer fokus.',
	...
	'fmt.dur.s': '{s} dtk',
	'fmt.dur.m': '{m} mnt',
	'fmt.dur.ms': '{m} mnt {s} dtk',
	'fmt.dur.h': '{h} jam',
	'fmt.dur.hm': '{h} jam {m} mnt',
